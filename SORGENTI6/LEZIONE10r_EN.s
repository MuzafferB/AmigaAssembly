...
; Lesson 10r.s    Filling a closed polygon
...
; During the copy, the area is also filled. The type of filling
...
move.w    #12,$64(a5)        ; BLTAMOD width 13 words (40-28=12)
...
lsr.w    #4,d1        ; clears the 4 lowest bits of X
...
In this example, we draw a closed polygon using lines.
As you can see, a small problem arises at the points where the lines touch,
 as we explained in the lesson.
In the next example, you will see the solution to this problem.
