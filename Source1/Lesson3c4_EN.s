...
mouse:
	...
	bsr.s    MoveCopper     ; Increasingly difficult
...
MoveCopper:
	LEA	BAR,a0    			; put the address of BARRA in a0:
	...
	addq.b    #1,8*9(a0)    ; last wait! (the BAR10 of the previous source)
Finished:
...
label itself, in this case BAR. However, the bar in question is made up
...
MoveCopper:
	...
	beq.s     Finished      ; defines the lower part of the bar.
	addq.b    #1,(a0)       ; change BAR:
	addq.b    #1,8(a0)    	; change byte 2 long after BAR:
	addq.b    #1,8*2(a0)    ; change byte 4 long after BAR:
