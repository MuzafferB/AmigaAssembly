...
; Lesson 10e1r.s    Blittata interleaved with copper monitor
;            Left key to exit.
...
MOVE.L    #$0f400,d2    ; line to wait for = $F4, i.e. 304
Waity1:
...
move.w    #000,$180(a5)        ; reset the black background
...
move.w	#(3*64*45)+18,$58(a5)    ; BLTSIZE (start the blitter!)
...
This program is the rawblit version of lesson10e1.s.
The measurement only takes into account the time taken by the blitter, and does not highlight
the advantages of rawblit. 
