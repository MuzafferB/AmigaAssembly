...
; Lesson 7d.s    A SPRITE MOVED VERTICALLY USING A TABLE OF PRE-SET VALUES
;        (i.e. vertical coordinates).
;        - Note that we can go down to the $FF line
;         and no further.
...
bsr.s    MoveSprite    ; Move sprite 0 vertically
...
MOVE.L    #TABY-1,TABYPOINT ; Start pointing to the first long again
NOBSTART:
moveq    #0,d0        ; Clear d0
...
dc.b	$CA,$C7,$C4,$C1,$BE,$BB,$B8,$B5,$B2,$AF,$AC,$A9 ; high from
dc.b    $A6,$A4,$A1,$9E,$9B,$98,$96,$93,$90,$8E,$8B,$88 ; record!
dc.b    $86,$83,$81,$7E,$7C,$79,$77,$74,$72,$70,$6D,$6B ; 200 values
...
Try replacing the current table with this one, and you will get a wobble
of the sprite. (Amiga+b+c+i to copy), (Amiga+b+x to delete a piece)


TABY:
dc.b	$8E,$91,$94,$97,$9A,$9D,$A0,$A3,$A6,$A9,$AC,$AF ; wobble
