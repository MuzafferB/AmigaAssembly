...
; Lesson 9l2.s    copy a rectangle between two overlapping areas
...
; is lower down, therefore at a higher address.
;****************************************************************************
...
move.l    #bitplane+((20*3*55)+64/16)*2,d2    ; destination ind.
...
In this example, we copy a rectangle between two overlapping areas. This time
the destination address is greater than the source address (on the
screen, the destination is lower down).
As you can see, the result is not what we wanted.
