...
mouse:
	...
	bsr.s    MoveCopper     ; The first movement on the screen!!!!!
							...
							; in fact bsr.s MoveCopper causes
							; the routine named MoveCopper to be executed,
...
In this program, a movement synchronised with the
...
plus the electronic brush position test; 
what you need to understand is that the routines, or subroutines, found between
...
;    bsr.s    MoveCopper    ; A routine executed every frame
;                			; (For fluidity)
...
find your way around. For example, if you duplicate the bsr.s Movecopper, the routine will be
