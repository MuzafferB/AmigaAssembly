...
; Asm Course - LESSON xx: ** PLAY VERY LONG SAMPLES **
...
move.w    d7,$9a(a6)		;turn off INT of the item
...
lea    plsregs(pc,d3.w),a1
movem.l    4*2(a1),d0/a0        ;grabs the working registers
lea    $dff0a0,a6
move.l    a0,$0(a6,d3.w)        ;sets AUDxLC
...
or.w    #$8000,d0
move.w    d0,$96(a6)        ;turns on old DMA
...
move.w d3,-(sp)
link a0,#0
.IRQLp: pea .irqlp(pc)        ;push the return for the RTS onto the stack
moveq #3,d3
