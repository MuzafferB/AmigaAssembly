...
MuoviCopper:
	cmpi.b    #$fa,BAR10 ; have we reached line $fa?
	beq.s	Finished       ; if so, we are at the bottom and do not continue
	addq.b    #1,BAR     ; WAIT 1 changed
	addq.b    #1,BAR2    ; WAIT 2 changed
	addq.b    #1,BAR3    ; WAIT 3 changed
	addq.b    #1,BAR4    ; WAIT 4 changed
	addq.b    #1,BAR5    ; WAIT 5 changed
	addq.b    #1,BAR6    ; WAIT 6 changed
	addq.b    #1,BAR7    ; WAIT 7 changed
	addq.b    #1,BAR8    ; WAIT 8 changed
	addq.b    #1,BAR9    ; WAIT 9 changed
	addq.b    #1,BAR10   ; WAIT 10 changed
Finished:
	rts
...
; Here is the COPPERLIST, pay attention to the BAR labels!!!!
